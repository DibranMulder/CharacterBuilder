...
- Light and Dark are permanent Lineage-derived Allegiances, not measures of
...
- Approved Weapon Families are Sword, Axe, Spear, Polearm, Crossbow, Bow, Wand,
  ...
  Weapons occupy both hands. Shields require Class permission;
  only Duelists may Dual Wield their permitted One-Handed Weapons.
...
counterpart. Variants within a Lineage retain identical gameplay permissions.
Every Lineage may choose every Combat Class; Class rules govern weapons.
Body topology still restricts equipment: Grove Centaurs cannot equip Legs/Feet
items (pants or boots), including invisible stat-only versions. Other compatible
slots remain available. See DESIGN-0012 for the armor-set exception.
...
- Are Sunscour anatomically distinct or Human-like? Their Dark Allegiance and
  separate playable Lineage identity are fixed regardless of the art decision.
