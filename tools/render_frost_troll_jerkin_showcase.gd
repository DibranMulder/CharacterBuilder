...
const OUTPUT_PATH := "res://artifacts/frost_troll_jerkin_showcase.png"
const VIEWPORT_SIZE := Vector2i(1200,760)
const TILE_SIZE := Vector2(400,380)
const SAMPLES := [
	{"title":"FRONT / STAND", "mode":&"stand", "time":0.0},
	{"title":"AXE / JAB", "mode":&"jab", "time":.30},
	{"title":"AXE / FOREHAND", "mode":&"forehand", "time":.38},
	{"title":"AXE / BACKHAND", "mode":&"backhand", "time":.39},
...
func _add_sample(canvas: Node2D,origin: Vector2,sample: Dictionary,index: int) -> void:
	...
	avatar.configure("frost_troll",{
		"weapon":"axe", "offhand":"none", "armor":"troll_jerkin",
		"pants":"leather", "boots":"none", "head":"none",
