...
func _render() -> void:
	...
	for frame in 6:
		await process_frame
	var result := viewport.get_texture().get_image().save_png("res://artifacts/frostling_reference_comparison.png")
